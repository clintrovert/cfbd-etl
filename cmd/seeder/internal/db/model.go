...
func (StatValue) TableName() string { return "cfbd.stat_values" }
...
func (Scoreboard) TableName() string { return "cfbd.scoreboard" }
...
func (PlayerPPAChartItem) TableName() string { return "cfbd.player_ppa_chart_items" }
...
func (PlayerUsageSplits) TableName() string { return "cfbd.player_usage_splits" }
...
func (AdvancedRateMetrics) TableName() string { return "cfbd.advanced_rate_metrics" }
...
func (AdvancedHavoc) TableName() string { return "cfbd.advanced_havoc" }
...
func (AdvancedFieldPosition) TableName() string { return "cfbd.advanced_field_position" }
...
func (AdvancedSeasonStatSide) TableName() string { return "cfbd.advanced_season_stat_sides" }
...
func (AdvancedSeasonStat) TableName() string { return "cfbd.advanced_season_stats" }
...
func (AdvancedGameStatSide) TableName() string { return "cfbd.advanced_game_stat_sides" }
...
func (AdvancedGameStat) TableName() string { return "cfbd.advanced_game_stats" }
...
func (GameHavocStatSide) TableName() string { return "cfbd.game_havoc_stat_sides" }
...
func (RecruitHometownInfo) TableName() string { return "cfbd.recruit_hometown_info" }
...
func (TeamSeasonPredictedPointsAdded) TableName() string { return "cfbd.team_season_ppa" }
...
func (TeamGamePredictedPointsAdded) TableName() string { return "cfbd.team_game_ppa" }
...
func (PlayerGamePredictedPointsAdded) TableName() string { return "cfbd.player_game_ppa" }
...
func (PlayerSeasonPredictedPointsAdded) TableName() string { return "cfbd.player_season_ppa" }
...
func (DraftPickHometownInfo) TableName() string { return "cfbd.draft_pick_hometown_info" }
...
func (Int32List) TableName() string { return "cfbd.int32_lists" }
